...
function TravelPlanCard({ destinationID, selectedPlan, setSelectedPlan, selectedActivities, setSelectedActivities, searchedTravelPlans, isSearched }) {
